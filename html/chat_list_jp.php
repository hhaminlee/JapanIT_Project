...
<body>
    ...
    <header class="purple-theme-shadow">
        ...
        <div class="navbar navbar-dark purple-theme shadow-sm">
            <div class="container">
              <a href="chat_list_jp.php" class="navbar-brand" style="display:justify-content:center; align-items: center;">
                ShitsuMun<i class="fa-regular fa-comments"></i>
              </a>
              <div class="button-container">                
              </div>
            </div>
            <span id="name_span"><strong><?php echo $nick; ?></strong>さま</span>
            <a class="button2" style="margin-right:10px" href="rule_jp.html">ルールビュー</a>
    ...
    <div class = "container1">
        ...
        <div id="main-chat">
            <div id="main-start-title">
                <a class="button" href="create_chatroom_jp.php">チャットルームを作成する</a>
            </div>            
    ...
    <div class="trans_nation">
        <a href="chat_list.php"><img src="mun-chan.png"></img></a>
    </div>
    <script>
        ...
        function loadChatrooms(){
            $.ajax({
                url: "load_chatrooms_jp.php",  // 이 PHP 파일은 아래에 작성하겠습니다.
                method: "GET",
