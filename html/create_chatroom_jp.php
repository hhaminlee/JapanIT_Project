...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result) {
        ...
        header("Location: chatroom_jp.php?id=$chatroom_id");
    } else {
...
<body>
    <div class = "myContents">
        <div class="myTitle">
            <a href="chat_list_jp.php"><h2>ShitsuMun <i class="fa-regular fa-comments"></i></h2></a>
        </div>
        <form action="create_chatroom_jp.php" method="post">
            <input type="text" name="chatroom_name" placeholder="Chatroom Name" required>
            <input type="text" name="keyword" placeholder="20の質問で使う単語を入力してください" required>
            <br>
            <br>
